...
/**
 * The basis of a {@link Matcher} for an {@link build.base.foundation.iterator.matching.Sequence}.
 *
 * @param <T> the type of elements evaluate
 */
abstract class AbstractSequence<T>
    ...
    AbstractSequence(final AbstractMatcher<T> previous) {
        super(previous);
    }
