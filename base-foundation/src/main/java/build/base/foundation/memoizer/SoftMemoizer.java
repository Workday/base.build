...
/**
 * A non-thread-safe {@link Memoizer} that holds memoized results with {@link SoftReference}s,
 ...
 * <p>
 * For concurrent use see {@link SoftConcurrentMemoizer}.
 *
 ...
 * @since Jun-2026
 */
final class SoftMemoizer<T, R> extends AbstractMemoizer<T, R> {

    SoftMemoizer(final Function<T, R> function, final Supplier<Map<Object, Object>> mapSupplier) {
