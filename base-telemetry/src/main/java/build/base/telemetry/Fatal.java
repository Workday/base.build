...
/**
 * {@link Telemetry} information recording a fatal, non-recoverable error.
 *
 * @author brian.oliver
 * @see Warning
 * @see Error
...
public interface Fatal
    extends ExceptionalTelemetry, ImplementationTelemetry {

    /**
     * Creates {@link Fatal} {@link Telemetry}.
     *
     ...
     * @return new {@link Fatal} {@link Telemetry}
     */
    static Fatal create(final URI uri,
