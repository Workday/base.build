...
/**
 * {@link Telemetry} information recording internal diagnostics.
 *
 * @author brian.oliver
 * @since Mar-2021
 */
public interface Diagnostic
    extends ImplementationTelemetry {

    /**
     * Creates {@link Diagnostic} {@link Telemetry}.
     *
     * @param uri       the source {@link URI}
     * @param locations the {@link Location}s
     * @param format    the format
     * @param args      the arguments
     * @return new {@link Diagnostic} {@link Telemetry}
     */
    static Diagnostic create(final URI uri,
