...
/**
 * {@link Telemetry} information recording that an {@link Activity} has commenced.
 *
 * @author brian.oliver
 * @since Mar-2021
 */
public interface Commenced
    extends Telemetry {
     ...
     * @return new {@link Commenced} {@link Telemetry}
     */
    static Commenced create(final URI uri,
