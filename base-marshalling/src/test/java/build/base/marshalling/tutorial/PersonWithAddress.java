...
/**
 * A marshallable person with an {@link Address}.
 *
 * @author brian.oliver
 * @since Jan-2025
 */
public class PersonWithAddress {
    ...
    /**
     * Constructs a {@link PersonWithAddress}.
     *
     ...
     */
    @Unmarshal
    public PersonWithAddress(final String firstName,
    ...
    /**
     * Destructs a {@link PersonWithAddress}
     *
     * @param firstName the first name
     * @param lastName  the last name
     */
    ...
    public boolean equals(final Object object) {
        ...
        if (!(object instanceof final PersonWithAddress that)) {
            return false;
        }
    ...
    static {
        ...
        Marshalling.register(PersonWithAddress.class, MethodHandles.lookup());
    }
}
