 ...
 * @since Jan-2025
 */
public class AggregateExpenseLine {

    private final AggregateExpense expense;
    private final String description;
    private final double amount;

    @Unmarshal
    public AggregateExpenseLine(@Bound final AggregateExpense expense,
    ...
    public AggregateExpense expense() {
        return this.expense;
    }
    ...
    public boolean equals(final Object o) {
        ...
        if (!(o instanceof final AggregateExpenseLine that)) {
            return false;
        }
    ...
    static {
        ...
        Marshalling.register(AggregateExpenseLine.class, MethodHandles.lookup());
    }
}
